...
| `~/Documents/soda-services/whisper-api` | 转写服务可编辑源码 | 否 |
| `~/Library/Application Support/SodaServices/whisper-api` | 转写服务运行副本 | 否 |
...
| `/Volumes/SodaMedia/whisper-api/venv` | 转写的大型 Python/模型依赖 | 长期保留，随版本维护 |
